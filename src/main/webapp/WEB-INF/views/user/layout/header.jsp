...
<div id="header-topbar-option" class="page-header-topbar">
   <nav id="topbar" role="navigation" style="margin-bottom: 0;" data-step="3" 
      ...
      <div class="navbar-header">
         ...
         <a id="logo" href="${pageContext.request.contextPath }" class="navbar-brand">
            ...
            <ul class="nav navbar navbar-top-links navbar-right mbn">
               ...
               <li class="dropdown">
                  ...
                  <ul class="dropdown-menu" role="menu">
                     ...
                     <li class="divider"></li>
                     <li><a href="logout.do"><i class="fa fa-key"></i>로그아웃</a></li>
                  </ul>
               </li>
            </ul>
         </div>
               ...
               <li class="dropdown">
                ...
                <li class="dropdown">
                   <label for="inputName" class="control-label text-yellow">패스워드 :</label>
                    <input type="text"  id="mem_pass"  name="mem_pass" placeholder="패스워드를 입력해주세요." 
                     class="text-yellow" />
               </li>
               <li>&nbsp;</li>   
                 <li class="dropdown">
                    <button type="submit" id="loginBtn" class="btn btn-warning btn-sm">로그인</button>
                </li>
            </ul>       
         </div>
         </c:if>
...
$(function() {
	$('#loginBtn').click(function() {
		...
		var hashingID =  CryptoJS.SHA256(mem_id).toString(CryptoJS.enc.Hex);
		...
		$frm.submit(); */
	      ...
	      location.href = '${pageContext.request.contextPath}/user/join/loginCheck.do?mem_id=' + mem_id + "&mem_pass=" + mem_pass;
